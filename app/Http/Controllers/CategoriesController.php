...
class CategoriesController extends Controller
{
    ...
    {
        $userId =  auth()->user()->id;
        $topicId = $request->input('current_topic_id', $request->input('current_topic_id_sub'));
        $group = $request->input('cat_title', '');
        $title = $request->input('sub_cat_title', '');
        $description = $request->input('sub_cat_description', '');
        ...
        // Create the category and retrieve the created model
        $newCategory = auth()->user()->definecategories()->create($mainCategoryData);

        // // Return the new category details in the response
        $responseData = [
