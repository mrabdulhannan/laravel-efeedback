        ...
        <div class="col-xxl-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h2 class="card-title">Edit Rubric</h2>
                                    ...
                                    <div class="tab-pane fade {{ $key === 0 ? 'active show' : '' }}"
                                        ...
                                        <div class="">
                                                    ...
                                                    <form action="{{ route('updaterubrics', ['id' => $rubric->id]) }}"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="#" class="btn btn-danger delete-rubric"
                                                                    data-rubric-id="{{ $rubric->id }}">X</a>
                                            ...
                                            <div class="card-header new-rubic mb-3">
                                                ...
                                                <button id="showFormBtn" class="btn btn-secondary"
                                                    onclick="showForm('{{ $topic->id }}')">Add New</button>

                                            </div>

                                            <form id="rubricForm_{{ $topic->id }}" action="{{ route('storerubrics') }}"
...
@push('script-page-level')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            if ($('#customTabs li a.active').length === 0) {
                // If no other tab has the 'active' class, add it to the first child
