...
@push('stylesheet-page-level')
    <style>
        .custom-light-gray-bg {
            ...
            /* Set your desired light gray color */
        }
    </style>
@endpush
                ...
                <div class="col-xxl-12">
                    ...
                    <div class="">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <label for="topic_title" class="form-label">Assessment <i>(like Leadership,

                                                        Organizational Behavior, Marketing etc...)</label>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-primary add-form-btn float-right"
